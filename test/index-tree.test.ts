...
import { it_clear, it_count_items, it_create, it_get_entry, it_set_range, ITContent, MAX_BOUND } from "../src/index-tree.js";
...
describe('index-tree', () => {
  test("create and clear", () => {
    const tree = it_create<SimpleContent>(simpleFuncs);
